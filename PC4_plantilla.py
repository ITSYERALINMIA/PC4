...
st.markdown("<h1 style='text-align: center;'>Un blog que te ayude a conocerme un poco</h1>", unsafe_allow_html=True)
...
col1.image("Foto de perfil.jpg", caption='Yeralin siendo porrista de Interfacultades', width=300)
...
texto = """
Hola, esta soy yo, Yeralin. Sorprendentemente en una etapa que no creí descubrir, que era ser porrista en la universidad. Pasa que, me gusta asumir retos y salir constantemente de mi zona de confort. Por otro lado, amo mi carrera y mi facultad, solo quiero avanzar y aprender todo lo necesario para el mundo laboral y a la vez crear un empredimiento personal o con algún amigo/familiar.
"""
...
texto_2 = """
Mi experiencia programando sin duda fue uno de los mayores retos como estudiante. Nunca imaginé que haría eso, puesto que, creía que solo era para ingenieros de sistemas o personas así. Sin embargo, se sintió muy satisfactorio aprender a hacer cosas po mi propia cuenta, como crear gráficos, diccionarios, cálculos, etc. Asimismo, considero que las prácticas fueron indispensable para entender mejor todos los conceptos teóricos. La experiencia me ha dejado con ganas de querer aprender más en este mundo de programación. 
"""
...
sidebar.markdown("<h1 style='text-align: center;'>Mapas y gráficos de mi PC3</h1>", unsafe_allow_html=True)
...
grafico_seleccionado = sidebar.selectbox('Mapas y gráficos', graficos)
...
if grafico_seleccionado == 'gráfico 1':
    sidebar.markdown("<div style='text-align: justify; font-size: 20px;'>Mapa interactivo que ubica las lenguas de la Familia Arakawan con un punto naranja", unsafe_allow_html=True)
    sidebar.image("gráfico 1.png", caption='Mapa de Ubicación de las lenguas de la Familia Arakawan', width=500)
    pass
elif grafico_seleccionado == 'gráfico 2':
    sidebar.markdown("<div style='text-align: justify'>El punto azul ubica en el mapa el lugar de rodaje de mis películas favoritas", unsafe_allow_html=True)
    sidebar.image("gráfico 2.png", caption='Lugar de rodaje de mis películas favoritas', width=500)
    pass
elif grafico_seleccionado == 'gráfico 3':
    sidebar.markdown("<div style='text-align: justify'>El contraste de colores evidencia claramente la diferencia de goles anotados por un equipo europeo", unsafe_allow_html=True)
    sidebar.image("gráfico 3.png", caption='Gráfico de pastel de goles anotados', width=500)
    pass
